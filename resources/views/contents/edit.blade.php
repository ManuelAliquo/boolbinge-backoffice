...
<div class="container my-4">
    ...
    <form class="card p-3 shadow-sm" action="{{route('contents.update', $content)}}"
        ...
        <div class="mb-4">
            ...
            <div class="form-search-results border rounded p-3 bg-white overflow-y-auto" id="performers-list">
            ...
            <div class="card p-2">
                <div class="d-flex gap-3 align-items-center">
                    <div class="flex-grow-1 ms-2">
                        ...
                        <input class="form-control mb-2" type="file" id="poster" name="poster">
                    </div>
                    @if($content->poster)
                    ...
                    <div class="flex-grow-1 ms-2">
                        <div class="d-flex align-items-center gap-3 flex-wrap mb-2">
                            ...
                            <div class="form-check form-switch d-flex align-items-center gap-2 mb-0">
                                ...
                                <label class="form-check-label text-danger fw-semibold" for="delete_background">
                                    Remove</label>
                            </div>
                            @endif
                        </div>
                        <input class="form-control mb-2" type="file" id="background" name="background">
                    </div>
                    @if($content->background)
